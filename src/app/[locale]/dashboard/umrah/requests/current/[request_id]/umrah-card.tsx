            ...
            <div>
              ...
              <p className="font-medium">
                {progress.ihram_started_at
                  ? format(
                      new Date(progress.ihram_started_at),
                      "yyyy-MM-dd hh:mm a"
                    )
                  : t("not_started")}
              </p>
              {progress.ihram_completed_at && (
                <p className="text-sm text-green-600">
                  {t("completed_at")}{" "}
                  {format(
                    new Date(progress.ihram_completed_at),
                    "yyyy-MM-dd hh:mm a"
                  )}
                </p>
              )}
            ...
            <div>
              ...
              <p className="font-medium">
                {progress.tawaf_started_at
                  ? format(
                      new Date(progress.tawaf_started_at),
                      "yyyy-MM-dd hh:mm a"
                    )
                  : t("not_started")}
              </p>
              {progress.tawaf_completed_at && (
                <p className="text-sm text-green-600">
                  {t("completed_at")}{" "}
                  {format(
                    new Date(progress.tawaf_completed_at),
                    "yyyy-MM-dd hh:mm a"
                  )}
                </p>
              )}
            ...
            <div>
              ...
              <p className="font-medium">
                {progress.sai_started_at
                  ? format(
                      new Date(progress.sai_started_at),
                      "yyyy-MM-dd hh:mm a"
                    )
                  : t("not_started")}
              </p>
              {progress.sai_completed_at && (
                <p className="text-sm text-green-600">
                  {t("completed_at")}{" "}
                  {format(
                    new Date(progress.sai_completed_at),
                    "yyyy-MM-dd hh:mm a"
                  )}
                </p>
              )}
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      ...
                      <div className="flex flex-col sm:items-end gap-2">
                        <div className="text-xl font-bold text-primary">
                          {formatPrice(offer.price, { isRTL: dir === "rtl" })}
                        </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="font-medium">
                  {format(new Date(umrah.created_at), "yyyy-MM-dd hh:mm a")}
                </p>
              </div>
            </div>
          </div>
