...
import { usePerformersReportQuery } from "@/lib/apis/reports";
import { IconUser, IconUserCheck } from "@tabler/icons-react";
import { Title } from "@/components/ui/typography";
import OverviewCard from "@/components/ui/overview-card";
import PerformersReportDataTable from "./data-table";
function ReportData() {
  ...
  const { data, isLoading } = usePerformersReportQuery(queryArgs, {
  ...
  return (
    <div className="flex gap-4 flex-col">
      ...
      <PerformersReportDataTable data={data!} isLoading={isLoading} />
    </div>
  );
}
