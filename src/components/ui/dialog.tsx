...
function DialogClose({
  ...
  return <DialogPrimitive.Close data-slot="dialog-close" className={cn(buttonVariants({ variant: "close" }))} {...props} />
}
...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-2 text-center ltr:sm:text-left rtl:sm:text-right", className)}
      {...props}
    />
  )
}
...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-2 sm:flex-row rtl:sm:justify-end ltr:sm:justify-start rtl:justify-end ltr:justify-start",
        className
      )}
      {...props}
    />
